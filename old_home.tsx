...
const services = [
  ...
  { name: "Grocery (GMart)", slug: "grocery", icon: ShoppingBasket, description: "Order fresh groceries with fast home delivery", badge: "Free Delivery ≡ƒÄë", color: "secondary" },
          ...
          <div className="cursor-pointer group">
            ...
            >
              ...
              <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-md px-2 py-0.5 rounded-full text-[10px] font-bold text-gray-800 flex items-center gap-1 shadow-sm">
                <span className="text-yellow-600">Γÿà</span> 4.5
              </div>
              {item.isVeg && (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-1">
                <span className="text-sm font-bold text-gray-900">Γé╣{item.price}</span>
          ...
          <div onClick={() => navigate(`/restaurants/${provider.id}`)} className="cursor-pointer group">
            ...
            <div className="flex items-center gap-3 text-xs text-gray-600">
              <span className="flex items-center gap-1 bg-green-50 text-green-700 px-1.5 py-0.5 rounded-md font-medium">
                <span className="text-green-600">Γÿà</span> 4.2
              </span>
              <span>ΓÇó 25 mins</span>
              <span>ΓÇó Γé╣200 for two</span>
            </div>
          </div>
        )}
      />
        ...
        renderItem={(cake: any) => (
          <div className="cursor-pointer group">
            ...
            >
              ...
              <p className="text-xs text-gray-500 truncate">{cake.weight || "1 kg"} ΓÇó {cake.flavor || "Chocolate"}</p>
              <div className="flex items-center justify-between mt-1">
                <span className="text-sm font-bold text-gray-900">Γé╣{cake.price}</span>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-card p-4 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] border-t z-[100] animate-in slide-in-from-bottom-5">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div>
              ...
              <p className="text-xl font-extrabold text-primary">Γé╣{getTotalPrice().toFixed(2)}</p>
            </div>
            <Button
