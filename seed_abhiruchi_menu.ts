...
async function seed() {
    ...
    const menuItems = [
        ...
        { name: "Extra Pav 2 pis.", category: "Misal", price: "100", isVeg: true }, // Wait, image says 10? Ah, misal extra pav is 10. Let me check. Misal: 50, extra pav 2 pis: 10. Yes.
    ...
    console.log(`Starting seeding for Hotel Abhiruchi (${providerId})...`);
