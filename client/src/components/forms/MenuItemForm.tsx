...
const cakeCategories = [{ value: "Birthday", label: "Birthday Cakes" }, { value: "Anniversary", label: "Anniversary Cakes" }, { value: "Wedding", label: "Wedding Cakes" }, { value: "Custom", label: "Custom Cakes" }, { value: "Cupcakes", label: "Cupcakes & Pastries" }, { value: "Accessories", label: "Cake Accessories" }, { value: "Decorations", label: "Cake Decorations" }, { value: "Tools", label: "Baking Tools" },];
